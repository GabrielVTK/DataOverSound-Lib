...
public class UtilsTest {
    ...
    public void testDoubleToByte() {
        ...
        short[] expectedShort = Utils.doubleToShort(input);
        byte[] expectedByte = Utils.shortToByte(expectedShort);

        // Quando o método é chamado
        byte[] result = Utils.doubleToByte(input);
    ...
    public void testDoubleToShort() {
        ...
        short[] result1 = Utils.doubleToShort(input1);
        ...
        short[] result2 = Utils.doubleToShort(input2);
        ...
        short[] result3 = Utils.doubleToShort(input3);
        ...
        short[] result4 = Utils.doubleToShort(input4);
        ...
        short[] result5 = Utils.doubleToShort(input5);
    ...
    public void testShortToByte() {
        ...
        byte[] result5 = Utils.shortToByte(input5);
        assertArrayEquals(expected5, result5);
    }
